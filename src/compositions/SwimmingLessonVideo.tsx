...
import transcriptData from '../../projects/swimming-lesson/transcript_transcript.json';
...
export const SwimmingLessonVideo: React.FC<{
  heroFontSize?: number;
  ...
  return (
    <MultiWordComposition
      ...
      audioFile="swimming-lesson/final_audio.mp3"
