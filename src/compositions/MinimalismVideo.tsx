...
import transcriptData from '../../projects/minimalism-video/transcript_transcript.json';
...
export const MinimalismVideo: React.FC<{
  heroFontSize?: number;
  ...
  return (
    <MultiWordComposition
      ...
      audioFile="minimalism-video/speech.mp3"
